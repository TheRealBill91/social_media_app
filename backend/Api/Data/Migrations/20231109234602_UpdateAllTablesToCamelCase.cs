...
namespace social_media_api.Migrations
{
    ...
    public partial class UpdateAllTablesToCamelCase : Migration
    {
        ...
        {
            migrationBuilder.DropTable(name: "CommentUpvote");

            migrationBuilder.DropTable(name: "FriendRequest");

            migrationBuilder.DropTable(name: "MemberProfile");

            migrationBuilder.DropTable(name: "PostUpvote");
