...
public class AuthController : BaseApiController
{
    ...
    public async Task<IActionResult> Signin([FromBody] SignInDTO form)
    {
        ...
        user ??= await _userManager.FindByNameAsync(form.Username);
    ...
    public async Task<IActionResult> GoogleResponse()
    {
        ...
        // User successfully signed in with Google; no further action needed.
        {
            ...
            {
                memberProfile.PhotoURL = pictureClaim;
    ...
    )
    {
        ...
        var NoAccountFoundMessage =
            "If an account associated with this email address exists, you will receive a password reset link momentarily";
