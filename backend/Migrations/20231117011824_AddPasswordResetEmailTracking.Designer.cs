...
namespace social_media_api.Migrations
{
    ...
    [Migration("20231117011824_AddPasswordResetEmailTracking")]
    partial class AddPasswordResetEmailTracking
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SocialMediaApp.Models.CommentUpvotes", b =>
                {
                    b.HasOne("SocialMediaApp.Models.Members", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_comment_upvote_member_members_id");
            ...
            modelBuilder.Entity("SocialMediaApp.Models.Comments", b =>
                {
                    b.HasOne("SocialMediaApp.Models.Members", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_comment_member_members_id");
            ...
            modelBuilder.Entity("SocialMediaApp.Models.FriendRequests", b =>
                {
                    b.HasOne("SocialMediaApp.Models.Members", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_friend_request_member_members_id");
                    ...
                    b.HasOne("SocialMediaApp.Models.Members", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_friend_request_member_members_id1");
                });
            ...
            modelBuilder.Entity("SocialMediaApp.Models.Friendships", b =>
                {
                    b.HasOne("SocialMediaApp.Models.Members", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_friendship_member_members_id");
                    ...
                    b.HasOne("SocialMediaApp.Models.Members", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_friendship_member_members_id1");
                });
            ...
            modelBuilder.Entity("SocialMediaApp.Models.MemberProfiles", b =>
                {
                    b.HasOne("SocialMediaApp.Models.Members", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_member_profile_member_members_id");
                });
            ...
            modelBuilder.Entity("SocialMediaApp.Models.PostUpvotes", b =>
                {
                    b.HasOne("SocialMediaApp.Models.Members", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_post_upvote_member_members_id");
            ...
            modelBuilder.Entity("SocialMediaApp.Models.Posts", b =>
                {
                    b.HasOne("SocialMediaApp.Models.Members", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_post_member_members_id");
                });
